...
class Notification {
	...
	public function  getNotifications($datda, $limit){
	...
	public function insertNotification($post_id, $user_to,$type){
		...
		$insert_query = mysqli_query($this->con, "INSERT INTO notifications VALUE('','$user_to','$userLoggedIn','$message','$link','$datetime','no','no')");
