...
class Post {
	...
	public function getSinglePost($post_id){
		...
		$opened_query = mysqli_query($this->con, "UPDATE notifications SET openend='yes' WHERE user_to='$userLoggedIn' AND link LIKE '%=post_id'");
		...
		if(mysqli_num_rows($data_query) > 0) {
			...
			echo "<p>No post found.If you clicked a link, iti may by broken.</p>";
			return;
		}
